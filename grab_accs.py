...
def test_find_accs():
    ...
    Test find_accs()
    '''
    data = ('(tr|L_Q0G839|L_Q0G839_CAEEL:0.1,tr|M_A0A091MYM1|I_A0A091MYM1_9PASS:0.2,' +
            '(tr|L_H2M6E8|L_H2M6E8_ORYLA:0.3,tr|L_C3Z2I6|M_C3Z2I6_BRAFL:0.4)' +
            '1.00:0.5)0.897;')
...
if __name__ == '__main__':
    if len(sys.argv) != 3:
        sys.stderr.write('Usage: {} <tree file> <pattern>\n'.format(sys.argv[1]))
        sys.exit(1)
